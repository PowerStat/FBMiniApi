 ...
 */
@ValueObject
public record ColorControl(EnumSet<ColorModes> supportedModes, ColorModes currentMode, boolean fullcolorsupport, boolean mapped, Hue hue, Saturation saturation, Hue unmappedHue, Saturation unmappedSaturation, TemperatureKelvin temperature) implements Comparable<ColorControl>, IValueObject
 {
  /**
   * Constructor.
   *
